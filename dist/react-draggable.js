...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
		...
		/**
			 * `onBeforeStart` executed prior to starting the drag.
			 *  providing an opportunity to cancel the drag based on application logic.
			 *  Returning false will prevent the drag.
			 * ```js
			 *	function (event) {}
			 * ```
	    ...
	    // }
			...
			// A chance to prevent the drag before any state changes occur
			if(this.props.onBeforeStart(e, this) === false) {
				return;
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactPropTransferer = __webpack_require__(7);
